...
to which it was applied, and returns a selection, called the _update_ selection, 
which consists of all the elements from the old selection to which we could bind data. 
